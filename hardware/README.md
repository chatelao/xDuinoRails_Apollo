...
| Function     | Pin Name | GPIO | Description                         |
|---------------|---------|----|---------------------------------------|
| BEMF B        | D0 / A0 | 26 | Back-EMF Measurement Input B          |
| BEMF A        | D1 / A1 | 27 | Back-EMF Measurement Input A          |
| I_MOTOR       | D2 / A2 | 28 | Current from motor to GND             |
| I_FUNC        | D3 / A3 | 29 | Current from functions to GND         |
| DCC ACK       | D4      |  6 | PWM Audio Output (Alternative to I2S) |
| DCC Signal    | D5      |  7 | (Available)                           |
| Motor A       | D7      |  1 | Motor Output A (PWM to BDR6133)       |
| Motor B       | D8      |  2 | Motor Output B (PWM to BDR6133)       |
| Headlight Fwd | D9      |  4 | Front Headlight (PWM capable)         |
| Headlight Rev | D10     |  3 | Rear Headlight (PWM capable)          |
